...
//内存池(32字节对齐)
u8 __attribute__((aligned(32))) mem1base[MEM1_MAX_SIZE];													//内部SRAM内存池
u8  __attribute__((aligned(32))) mem2base[MEM2_MAX_SIZE] __attribute__((at(0XC01F4000)));					//外部SDRAM内存池,前面2M给LTDC用了(1280*800*2)
u8  __attribute__((aligned(32))) mem3base[MEM3_MAX_SIZE] __attribute__((at(0X10000000)));					//内部CCM内存池
//内存管理表
